...
//	gl_FragColor = texture2D(texture, gl_TexCoord[0].xy);
	float n = sOctaveNoise(v_texCoord3D, 1.0, 6);
    gl_FragColor = mix(vec4(0.5 + 0.5*vec3(n,0.0,0.0), 1.0),
					   texture2D(texture, gl_TexCoord[0].xy),// gl_TexCoord[0].xy),
						 1.0);

	//gl_FragColor = vec4(gl_TexCoord[1].xy*0.5+0.5, 0.0, 0.0);
...
//	gl_FragColor = texture2D(texture, gl_TexCoord[0].xy);
	float n = sOctaveNoise(v_texCoord3D, 1.0, 6);
    gl_FragColor = mix(vec4(0.5 + 0.5*vec3(n,0.0,0.0), 1.0),
					   texture2D(texture2, gl_TexCoord[3].xy),// gl_TexCoord[0].xy),
						 1.0);
	gl_FragColor = vec4(0.5 + 0.5*vec3(n), 1.0);			 
