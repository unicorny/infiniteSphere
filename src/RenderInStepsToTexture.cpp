...
RenderInStepsToTexture::RenderInStepsToTexture(RenderToTexture* frameBuffer)
...
DRReturn RenderInStepsToTexture::init(float stepSize, DRVector2 textureSize, float clippingBorder[4], GLuint &texture)
{
    mStepSize = stepSize;
    ...
    GLuint t = texture;
    //texture = mFrameBuffer->switchTexture(t);
